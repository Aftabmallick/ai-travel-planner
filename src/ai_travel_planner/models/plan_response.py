...
class PlanResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["plan_id", "status", "stage", "draft_itinerary"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of draft_itinerary
        if self.draft_itinerary:
            _dict['draft_itinerary'] = self.draft_itinerary.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "stage": obj.get("stage"),
            "draft_itinerary": Itinerary.from_dict(obj.get("draft_itinerary")) if obj.get("draft_itinerary") is not None else None
        })
        return _obj
