...
class ReviewRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["action", "comments", "modifications"]

    @field_validator('action')
    def action_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('approve', 'reject', 'modify',):
            raise ValueError("must be one of enum values ('approve', 'reject', 'modify')")
        return value
